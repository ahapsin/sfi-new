<template>
    <div class="flex gap-4 w-full">
        <div class="w-full">
            <n-space vertical>
                <n-card :class="`shadow-md`"  :title="`Pindah Buku Antar Rekening`" :segmented="true" size="small">
    ...
    <n-modal v-model:show="modalPinbuk">
        <n-card ::class="`shadow-md`"  class="w-[80%]" title="Pindah Buku Antar Rekening" :segmented="true" size="small">
